...
const MESSAGES: Record<string, FormSectionMessages> = {
  ...
  nl: {
    ...
    successMessage: 'Uw bericht is verzonden. Bedankt!',
    errorMessage:   'Er is iets misgegaan — probeer het opnieuw.',
    continueLabel:  'Volgende',
    stepLabel:      'Stap {current} van {total}',
    requiredHint:   'Velden met een * zijn verplicht.',
    backLabel:      'Terug',
    reviewTitle:    'Controleer uw gegevens',
    editLabel:      'Bewerken',
    whatsappChat:    'Chat via WhatsApp',
    whatsappSend:    'Verzenden via WhatsApp',
    whatsappTitle:   'Stuur ons een bericht op WhatsApp',
    whatsappOpening: 'WhatsApp wordt geopend…',
  },
  pt: {
    submitLabel:    'Enviar mensagem',
    submitting:     'A enviar…',
    successMessage: 'A sua mensagem foi enviada. Obrigado!',
    errorMessage:   'Algo correu mal — por favor, tente novamente.',
    continueLabel:  'Seguinte',
    stepLabel:      'Passo {current} de {total}',
    requiredHint:   'Os campos marcados com * são obrigatórios.',
    backLabel:      'Voltar',
    reviewTitle:    'Reveja os seus dados',
    editLabel:      'Editar',
    whatsappChat:    'Falar no WhatsApp',
    whatsappSend:    'Enviar no WhatsApp',
    whatsappTitle:   'Envie-nos uma mensagem no WhatsApp',
    whatsappOpening: 'A abrir o WhatsApp…',
  },
}
